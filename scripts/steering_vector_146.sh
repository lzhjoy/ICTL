...
# debug
src_datasets=("arc_challenge")
tar_datasets=("arc_easy")
...
do
    ...
    do
        ...
        do
            ...
            do
                CUDA_VISIBLE_DEVICES=5,6 /home/tangxinyu/.conda/envs/re4r/bin/python src/run_steering_vector.py --src_datasets $src_dataset --tar_datasets $tar_dataset --shot_num $shot_num --shot_method $shot_method
            done
        done
    done
done

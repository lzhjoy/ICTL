...
do
    ...
    do
        ...
        do
            ...
            do
                CUDA_VISIBLE_DEVICES=7,8 /home/tangxinyu/anaconda3/envs/ictl/bin/python src/run_few_shot.py --src_datasets $src_dataset --tar_datasets $tar_dataset --shot_num $shot_num --shot_method $shot_method
            done
        done
    done
done
